...
class test::AnalyzeIt : public art::EDAnalyzer {
public:
  explicit AnalyzeIt
(fhicl::ParameterSet const& p);
  ...
  AnalyzeIt(AnalyzeIt const&) = delete;
  AnalyzeIt(AnalyzeIt&&) = delete;
  AnalyzeIt & operator=(AnalyzeIt const&) = delete;
  AnalyzeIt & operator=(AnalyzeIt &&) = delete;
...
test::AnalyzeIt::AnalyzeIt(fhicl::ParameterSet const& p)
  : EDAnalyzer{p},
...
void test::AnalyzeIt::analyze(art::Event const& e)
{
  // Implementation of required member function here.
  std::cout<<"Running AnalyzeIt---run="<< e.id().run()<<" --subrun="<< e.id().subRun()<<" --event="<<e.id().event()<<"\n";
...
DEFINE_ART_MODULE(test::AnalyzeIt)
